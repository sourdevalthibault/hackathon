...
my_files = ['../video_features/keyframes_final_features.csv', 
            '../others/audio.csv', 
            '../others/metadata.csv', 
            '../others/top_colors.csv', 
            '../others/video_text.csv', 
            '../others/attention.csv', 
            '../others/vggish.csv',
            '../old_video_features/keyframes_final_features.csv']
